...
import androidx.arch.lifecycle.ViewModelProviders;
...
import com.example.deybi_rivera_2doparcial_prueba_01.eventhandlers.PreferenceChangeListener;
import com.example.deybi_rivera_2doparcial_prueba_01.lifecyclehelpers.QuizViewModel;
...
public class DPRR_Primero_Flag extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (preferencesChanged) {
            this.quizFragment = (FirstFragment) getSupportFragmentManager()
